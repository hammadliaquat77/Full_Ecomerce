...
function Footer() {
  return (
    <>
      <div className="bg-gray-200 p-8 w-4/5 md:w-3/5 mx-auto rounded-lg shadow-lg absolute left-0 right-0 md:-mt-24 -mt-24">
      ...
      <footer className=' bg-gray-800 text-white md:p-14 md:-mt-8 -mt-16'>
        <div className=' text-white md:-mt-2 mt-16' >
          <div className='container mx-auto md:px-32 p-20 w-full pt-48 md:pt-20'>

    ...
    <>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center gap-10'>
          ...
          <div className='w-full md:w-3/5 space-y-4 text-center md:text-left'>
            ...
            <p className='text-gray-700 leading-relaxed'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
              ...
              Ratione.</p>
            <button className='bg-blue-700 px-6 py-3 text-white hover:bg-blue-800 transition rounded-lg'>Shop Now</button>
          </div>
      ...
      <section className='bg-gray-100'>
        <div className='container mx-auto md:px-32 md:py-20 md:space-y-10'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 p-14 md:p-0'>
            <div className='relative w-full md:w-64 bg-gray-300 p-2'>
      ...
      <section className='bg-white' >
          <div className='container mx-auto md:px-32'>
            ...
            {/* card 1 */}
             <div className='w-full md:w-72 md:h-64 p-12 md:p-0 bg-gray-300 rounded-2xl flex flex-col justify-center items-center space-y-4'>
              ...
              {/* card 2 */}
                <div className='w-full md:w-72 md:h-28 p-12 md:p-0 bg-gray-300 rounded-2xl flex  gap-6 justify-center items-center space-y-4'>
